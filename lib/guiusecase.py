...
class UIMap:
    ...
    def findPossibleSectionNames(self, widget):
        return [ "Name=" + widget.getName(), "Title=" + str(widget.getTitle()), 
                 "Label=" + str(widget.getLabel()) ]
    ...
    def getSectionName(self, widget):
        ...
        if not widget.isAutoGenerated(widgetName): 
