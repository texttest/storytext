    ...
    def collectNames(self):
        ...
        if response == gtk.RESPONSE_ACCEPT:
            ...
            if len(autoGenerated) > 0:
                ...
                for ((_, _, widgetDescription, signalName), eventName) in toStore:
