...
# storytext_release.py : makes a release from Bazaar source control. Can do so from a local setup using the
# environment variable BZRROOT (modelled on the layout at Jeppesen), or directly from Launchpad.

# Usage storytext_release.py [ -v <release_name> ] [ -t <tag> ] [ -x ] [ -d <working_dir> ]
